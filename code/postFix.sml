...
fun toPostFix(l) =
  let
    fun	toPostFix'([], EmptyStack, q) = (print("Done \n");q) (*Base case*)
      ...
      | toPostFix'(Variable(n)::xs, s, q) = (print("Add Variable to q \n");toPostFix'(xs,s, Variable(n)::q)) (*Input is a Number, moves it to the output queue*)
      ...
      | toPostFix'( head::xs, EmptyStack, q) = (print("Adding operator to empty stack \n");toPostFix'(xs, push(EmptyStack, head), q))(*Operator added to otherwhise empty stack*)
