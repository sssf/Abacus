...
\begin{description}
  ...
  \item [Compiler] \hfill
    \begin{itemize}
      \item Tokenize: split input text into expression of tokens tagged as Number, Variable, Function, Operator, Assignment, Negatation, Open or Close parenthesis
      ...
      \item Translate: convert tokens from infix notation to  postfix notation
      \end{itemize}    
  \item [Evaluation] \hfill \\ Compiled expression gets evaluated upon whether it is valid or not. A stack based "virtual Machine" evaluates expreesion as following rules, num pushed onto stack; processcor\footnote{functions are treated the same way as operators in a virtual machine,} encountered,takes item from stack;)
\end{description}
